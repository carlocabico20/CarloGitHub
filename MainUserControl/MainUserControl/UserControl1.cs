...
namespace MainUserControl
{
    ...
    public partial class UserControl1: UserControl
    {
        ...
        {
            int value;
            if (OPStatText.Text == "0")
            {
                value = 0;
            }
            else if (OPStatText.Text == "1")
            {
                value = 1;
            }
            else if (OPStatText.Text == "2")
            {
                value = 2;
            }
            else
        ...
        //         {
        //             ButtonUserControl.UserControl1 btn = new ButtonUserControl.UserControl1();
        ...
        //public void CheckButtonStatus(ButtonUserControl.UserControl1 btn, Button btnVal)
        //{
        //    String[] target = new String[3];
        //    for (int l = 0; l < btn.Btns.Length ; l++)
        //    {
        //        target[0] = btn.SwBtnTextbox;
        //        target[1] = btn.DoBtnTextbox;
        //        target[2] = btn.AnsBtnTextbox;
        //    };
